...
from algorithms.GreedyWeight import G_weight, import_csv
...
def run(self, weight):
    ...
    tps, Benefice, capacite_prise, resultat = G_weight(weight, array)
...
def greedyWeightTab(self):

    self.greedy_weight_layout = QVBoxLayout()
    welcome = QLabel('Greedy Weight')
    ...
    self.greedy_weight_layout.addWidget(welcome)
    self.greedy_weight_layout.addWidget(upload)
    ...
    self.greedy_weight_layout.addWidget(calcualte)

    self.greedy_weight_layout.addStretch(0)
    main = QWidget()
    main.setLayout(self.greedy_weight_layout)
    return main
...
def showResult(self, data):
    ...
    self.greedy_weight_layout.addWidget(table)
    self.greedy_weight_layout.addStretch(5)
