...
from algorithms.ExtendedGreedyEfficiency import G_ext_efficieny, import_csv
...
def run(self, weight):
    ...
    tps, Benefice, capacite_prise, resultat = G_ext_efficieny(weight, array)
...
def extendedGreedyEfficiencyTab(self):

    self.extended_greedy_efficiency = QVBoxLayout()
    welcome = QLabel('Extennded Greedy Efficiency')
    ...
    self.extended_greedy_efficiency.addWidget(welcome)
    self.extended_greedy_efficiency.addWidget(upload)
    ...
    self.extended_greedy_efficiency.addWidget(calcualte)

    self.extended_greedy_efficiency.addStretch(0)
    main = QWidget()
    main.setLayout(self.extended_greedy_efficiency)
    return main
...
def showResult(self, data):
    ...
    self.extended_greedy_efficiency.addWidget(table)
    self.extended_greedy_efficiency.addStretch(5)
