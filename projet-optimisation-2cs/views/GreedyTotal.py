...
from algorithms.GreedyTotal import G_Totalvalue, import_csv
...
def run(self, weight):
    ...
    tps, Benefice, capacite_prise, resultat = G_Totalvalue(weight, array)
...
def greedyTotalTab(self):

    self.greedy_total_layout = QVBoxLayout()
    welcome = QLabel('Total value heuristic')
    ...
    self.greedy_total_layout.addWidget(welcome)
    self.greedy_total_layout.addWidget(upload)
    ...
    self.greedy_total_layout.addWidget(calcualte)

    self.greedy_total_layout.addStretch(0)
    main = QWidget()
    main.setLayout(self.greedy_total_layout)
    return main
...
def showResult(self, data):
    ...
    self.greedy_total_layout.addWidget(table)
    self.greedy_total_layout.addStretch(5)
