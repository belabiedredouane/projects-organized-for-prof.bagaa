...
def run(self, weight):
    ...
    tps, Benefice, capacite_prise, resultat = BranchBound(weight, array)
...
def branchTab(self):
    ...
    self.branch_layout = QVBoxLayout()
    ...
    self.branch_layout.addWidget(welcome)
    self.branch_layout.addWidget(upload)
    ...
    self.branch_layout.addWidget(calcualte)

    self.branch_layout.addStretch(0)
    main = QWidget()
    main.setLayout(self.branch_layout)
    return main
...
def showResult(self, data):
    ...
    self.branch_layout.addWidget(table)
    self.branch_layout.addStretch(5)
