...
from algorithms.GreedyProfit import G_Benefice, import_csv
...
def run(self, weight):
    ...
    tps, Benefice, capacite_prise, resultat = G_Benefice(weight, array)
...
def greedyProfitTab(self):

    self.greedy_profit_layout = QVBoxLayout()
    welcome = QLabel('Greedy Profit')
    ...
    self.greedy_profit_layout.addWidget(welcome)
    self.greedy_profit_layout.addWidget(upload)
    ...
    self.greedy_profit_layout.addWidget(calcualte)

    self.greedy_profit_layout.addStretch(0)
    main = QWidget()
    main.setLayout(self.greedy_profit_layout)
    return main
...
def showResult(self, data):
    ...
    self.greedy_profit_layout.addWidget(table)
    self.greedy_profit_layout.addStretch(5)
